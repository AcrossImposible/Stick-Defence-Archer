...
public class Chunck : MonoBehaviour
{
    ...
    public List<Vector2Int> backTiles = new List<Vector2Int>();
    public List<Vector2Int> backTilesBackLayer = new List<Vector2Int>();
    ...
    Dictionary<Vector3Int, Interactable> interactableBlocks = new Dictionary<Vector3Int, Interactable>();

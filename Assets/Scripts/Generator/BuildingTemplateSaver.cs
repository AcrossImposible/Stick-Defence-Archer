...
public class BuildingTemplateSaver : MonoBehaviour
{
    ...
    void LoadToEdit()
    {
        ...
        List<Vector2?> reservedTilesFirstLayer = new List<Vector2?>();// Тут хранится информация
        List<Vector2?> reservedTilesBackLayers = new List<Vector2?>();// о тайлах, которые не нужно
